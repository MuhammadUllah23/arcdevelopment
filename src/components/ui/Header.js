        ...
        <React.Fragment>
            <SwipeableDrawer disableBackdropTransition={!iOS} disableDiscovery={iOS} open={openDrawer} onClose={() => setOpenDrawer(false)} onOpen={() => setOpenDrawer(true)} classes={{paper: classes.drawer}}>
                ...
                <List disablePadding>
                    ...
                    <ListItem onClick={() => {setOpenDrawer(false);  props.setValue(5)}} divider button component={Link} to="/estimate" selected={ props.value === 5} classes={{root: classes.drawerItemEstimate, selected: classes.drawerItemSelected}}>
